...
public class DefaultMessage implements TextMessage, ImageMessage,LinkMessage,
	...
	// text com.yaoling.h5.module.message
	@XmlElement
	...
	// event com.yaoling.h5.module.message
	@XmlElement
	...
	// location com.yaoling.h5.module.message
	@XmlElement
	...
	// link com.yaoling.h5.module.message
	@XmlElement
...
//		try{
//		WXBizMsgCrypt crypt = new WXBizMsgCrypt(EnvHelper.getComponentToken(), EnvHelper.getComponentAESKey(),EnvHelper.getComponentAppid());
//		return crypt.encryptMsg( this.toString(),String.valueOf(System.currentTimeMillis()/1000),String.valueOf(new Random().nextInt()) );
...
//		}
	...
	public String toString() {
		...
		if(this.getEncrypt()!=null) xml.append("<Encrypt>").append(this.Encrypt).append("</Encrypt>");
